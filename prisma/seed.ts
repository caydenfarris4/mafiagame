...
const clues = [
  ...
  { code: "2-2", phase: 2, tag: "KEEP", title: "A scrap of green tweed", location: "Living room — inside the inner pocket of Hank's jacket in the entryway coat closet.", content: "A scrap of dark green tweed, torn at the edges. Wasn't Richard wearing a jacket like this?" },
  ...
  { code: "2-4", phase: 2, tag: "ANNOUNCE", title: "Evidence photo: a footprint", location: "Outside — under the upturned blue kayak.", content: "A damp footprint on the patio stones, pointed at the dock. Looks like a men's shoe. Could be anyone's. Could be." },
  ...
  { code: "2-7", phase: 2, tag: "KEEP", title: "A balled-up cocktail napkin", location: "Dining room — taped under the bench with the decorative lanterns.", content: "A balled-up napkin. Plane tickets, reservations — all crossed out. “GONE.” Whose writing is this?" },
  // Phase 3
  { code: "3-1", phase: 3, tag: "ANNOUNCE", title: "A burned page of manuscript", location: "Fireplace — in the hearth, among the cooled ash.", content: "A page that didn't finish burning. “…her revenge wrapped in a memoir.” Someone wanted this gone." },
  { code: "3-2", phase: 3, tag: "ANNOUNCE", title: "A thank-you note", location: "Guest bedrooms — Richard's room, on the desk under a paperweight.", content: "A thank-you note, signed only “E.H.” So Eden was in his room too." },
  { code: "3-3", phase: 3, tag: "KEEP", title: "Saturday itinerary", location: "Guest bedrooms — Richard's room, inside the leather portfolio (now empty of the envelope).", content: "Richard's itinerary. Penciled into the 3 PM slot: “Pull V aside. Tell her about T.” Tell her what?" },
  { code: "3-4", phase: 3, tag: "KEEP", title: "An opened letter to Vivienne", location: "Guest bedrooms — Richard's room, top dresser drawer under folded socks.", content: "An opened letter to Vivi. “My answer is no.” He'd already turned her down." },
  { code: "3-5", phase: 3, tag: "KEEP", title: "An empty root beer bottle", location: "Outside — in the recycling bin under newspapers.", content: "An empty root beer bottle, wiped clean. Richard never let anyone near his stash." },
  ...
  { code: "3-7", phase: 3, tag: "KEEP", title: "A marina boarding ticket", location: "Guest bedrooms — Levi's room, under the mattress.", content: "A boarding ticket. Lake Saunders Marina, checked in 9:48 PM. Someone wasn't where they said they were." },
  { code: "3-8", phase: 3, tag: "ANNOUNCE", title: "A hand-drawn dock diagram", location: "Downstairs — taped behind the orca mural (peel it forward).", content: "A diagram of the dock. Times marked, an arrow drawn toward the water. This wasn't a fall. Someone planned it." },
  { code: "3-9", phase: 3, tag: "KEEP", title: "The missing root beer case", location: "Outside — under the second blue kayak.", content: "Richard's missing case of root beer, hidden under a kayak. Five bottles left. Who took it?" },
  { code: "3-10", phase: 3, tag: "KEEP", title: "A handwritten ledger", location: "Downstairs — in the games area, inside a Monopoly box between the rules booklet and lid.", content: "A ledger in small, careful handwriting. Inheritance weighed against debt. Someone was counting on that money." },
  // Phase 4
  { code: "4-1", phase: 4, tag: "ANNOUNCE", title: "The notarized will", location: "Dining room — inside the inner pocket of Sebastian's navy blazer on his breakfast chair.", content: "A notarized envelope, hidden in a blazer pocket. The will. “I leave the entirety of my estate — Crookshank Inns, every property, the house, all of it — to TURD: the Tortoise Urgent Rescue Division.” Everything. To the tortoises. Not the family." },
  { code: "4-2", phase: 4, tag: "KEEP", title: "A scrap: “11:35 — go”", location: "Guest bedrooms — Sebastian and Vivi's room, folded inside the nightstand drawer.", content: "A scrap of paper: “11:35 — go.” That's Vivi's handwriting." },
  { code: "4-3", phase: 4, tag: "ANNOUNCE", title: "Opera binoculars", location: "Balcony — propped between the loveseat cushions.", content: "Opera binoculars on the balcony loveseat. The lens is still warm. Someone stood up here, watching the dock." },
  { code: "4-4", phase: 4, tag: "KEEP", title: "A sticky note", location: "Master suite — in the master bathroom trash, under tissues.", content: "A sticky note, balled up in the trash. Smoothed out, it reads: “breathe. it's done.” Done… what?" },
  { code: "4-5", phase: 4, tag: "KEEP", title: "The 11:35 bonfire photo", location: "Downstairs — under the rim of the ping pong table, kitchen-side.", content: "This is from the bonfire last night… everyone gathered round the fire. But something seems off." },
  // Phase 5
