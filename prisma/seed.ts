...
const clues = [
  ...
  { code: "2-4", phase: 2, tag: "ANNOUNCE", title: "Evidence photo: a footprint", location: "Patio — under the upturned blue kayak.", content: "A damp footprint on the patio stones, pointed at the dock. Men's eleven. Could be anyone's. Could be." },
  ...
  { code: "3-9", phase: 3, tag: "KEEP", title: "The missing root beer case", location: "Patio — under the second blue kayak.", content: "Richard's missing case of root beer, hidden under a kayak. Eleven bottles left. Who took it?" },
  ...
  { code: "4-5", phase: 4, tag: "KEEP", title: "The 11:35 bonfire photo", location: "Bottom floor — under the rim of the ping pong table, kitchen-side.", content: "This is from the bonfire last night… everyone gathered round the fire. But something seems off. Like someone should be in this picture who isn't." },
  // Phase 5
