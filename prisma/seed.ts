...
const clues = [
  // Phase 2
  { code: "2-1", phase: 2, tag: "ANNOUNCE", title: "A torn corner of paper", location: "Living room — taped behind the framed nautical chart of Gig Harbor (cove circled in red).", content: "In Richard's handwriting: “…told her this afternoon. She took it well, I think. Better than I expected, actually. Maybe I underestimated her.”" },
  { code: "2-2", phase: 2, tag: "KEEP", title: "A scrap of green tweed", location: "Entryway — inside the inner pocket of Hank's jacket in the coat closet.", content: "A small snip of dark green tweed fabric, torn-edged. Torn from a green tweed jacket." },
  { code: "2-3", phase: 2, tag: "KEEP", title: "Letter from Richard's attorney", location: "Kitchen — behind the cookbooks on the open shelves.", content: "A typed fragment on cream paper: “…final draft of the trust beneficiary, as discussed. Per your instructions, this version replaces all prior. I'll bring the executed copy to the lake house Friday.”" },
  { code: "2-4", phase: 2, tag: "ANNOUNCE", title: "Evidence photo: a footprint", location: "Patio — under the upturned blue kayak.", content: "EVIDENCE PHOTO, Sunday 7:55 AM. A damp footprint on the patio stones, facing the dock. Size: MEN'S 11. Direction: toward the dock. Found by: A." },
  { code: "2-5", phase: 2, tag: "KEEP", title: "Richard's “Final List”", location: "Living room — folded inside the small plant pot, between soil and liner.", content: "In Richard's handwriting, headed “Gig Harbor Visit — Final List”: 1. Hank (crossed out) 2. Catherine (crossed out) 3. Beau (crossed out) 4. Levi (crossed out) 5. Cody (crossed out) 6. [a name, smudged illegible] 7. Eden (crossed out)" },
  { code: "2-6", phase: 2, tag: "KEEP", title: "A grocery receipt", location: "Kitchen — in the freezer, taped to the bottom of the ice cream tub.", content: "Friday receipt, customer R. CROOKSHANK: Solomon's birdseed $8.49 · Glass-bottle root beer (case) ×2 $43.98 · Tortoise figurine, ceramic $24.00 · Peppermint tea $11.50 · Lobster forks ×3 $36.00. TOTAL: $123.97" },
  { code: "2-7", phase: 2, tag: "KEEP", title: "A balled-up cocktail napkin", location: "Dining area — taped under the bench with the decorative lanterns.", content: "A shopping list scribbled and crossed out: “plane tickets — NYC reservations — tortoise figurine — GONE.”" },
  // Phase 3
  { code: "3-1", phase: 3, tag: "ANNOUNCE", title: "A burned page of manuscript", location: "Patio — in the bonfire pit, in the cooled ash.", content: "A partially burned typed page: “…Aunt Catherine had always known the secret about her own mother, but the family pretended. She had decided this would be the year. The book would be her revenge wrapped in a memoir…”" },
  { code: "3-2", phase: 3, tag: "ANNOUNCE", title: "A thank-you note", location: "Richard's guest room — on the desk, under a paperweight.", content: "On cream stationery: “Mr. Crookshank — Thank you for the book of your mother's poems. It meant more than you know. — E.H.”" },
  { code: "3-3", phase: 3, tag: "KEEP", title: "Saturday itinerary", location: "Richard's guest room — inside the leather portfolio (now empty of the envelope).", content: "A typed Saturday itinerary. The 3 PM slot has a handwritten note in Richard's hand: “3 PM — Pull V aside. Tell her about T. Be gentle. She'll understand.”" },
  { code: "3-4", phase: 3, tag: "KEEP", title: "An opened letter to Vivienne", location: "Richard's guest room — top dresser drawer, under folded socks.", content: "An opened envelope addressed to “Vivienne H.” in Richard's hand: “My dear Vivi — I read your last note. My answer is no, but let me explain. The theater is wonderful, but it doesn't pay rent in Manhattan, and I'm not in the business of subsidizing dreams. I love you for asking. — R.”" },
  { code: "3-5", phase: 3, tag: "KEEP", title: "An empty root beer bottle", location: "Patio — in the recycling bin under newspapers.", content: "An empty glass-bottle root beer bottle. Label intact. No fingerprints." },
  { code: "3-6", phase: 3, tag: "ANNOUNCE", title: "A torn guestbook page", location: "Gazebo — under the cushion of the wicker chair where Solomon's perch sits.", content: "A torn page from the lake house guestbook: “Saturday — Please let me know what you decide. Your support means the world. The kids in Cambodia need this. — Bella R.”" },
  { code: "3-7", phase: 3, tag: "KEEP", title: "A marina boarding ticket", location: "Levi's bedroom — under the mattress.", content: "A creased boarding ticket: LAKE SAUNDERS HOUSEBOAT MARINA, Slip 14, Saturday Night Card Game. Check-in: 9:48 PM. Guest of: WYATT P." },
  { code: "3-8", phase: 3, tag: "ANNOUNCE", title: "A hand-drawn dock diagram", location: "Bottom floor — taped behind the orca mural (peel it forward).", content: "A diagram of the dock on graph paper. “11:30 PM” circled at the bonfire; “11:50 PM” written below; between them an arrow toward the dock labeled “~12 min walk.” Someone planned this." },
  { code: "3-9", phase: 3, tag: "KEEP", title: "The missing root beer case", location: "Patio — under the second blue kayak.", content: "A case of Richard's personal root beer, eleven bottles remaining (one missing). Found under the second kayak." },
  { code: "3-10", phase: 3, tag: "KEEP", title: "A handwritten ledger", location: "Bottom floor games area — inside a Monopoly box, between the rules booklet and lid.", content: "Small, neat handwriting (Sebastian's). INHERITANCE (est.): Crookshank Inns $11.4M · Bainbridge house $2.1M · Liquid ~$500K = $14M. OWED: MBA loans $312K · NYC apartment $180K · Private placement deposit $750K = $1.24M. “Buffer ratio: 11.6×. Comfortable.”" },
  // Phase 4
  { code: "4-1", phase: 4, tag: "ANNOUNCE", title: "The notarized will", location: "Dining area — inside the inner pocket of Sebastian's navy blazer on his breakfast chair.", content: "A heavy cream envelope, notary stamp visible, addressed “Executor — Crookshank Inns Estate.” Inside: “I, Richard Carlton Crookshank, of sound mind and overflowing affection for the slowest creatures on God's green earth, do hereby leave the entirety of my estate — Crookshank Inns, all twenty-three properties, the Bainbridge house, my liquid assets, and Solomon — to TURD: The Tortoise Urgent Rescue Division, Olympia, Washington. Notarized. — R.C.C.”" },
  { code: "4-2", phase: 4, tag: "KEEP", title: "A scrap: “11:35 — go”", location: "Same blazer pocket as 4-1, folded behind the envelope.", content: "A small scrap of paper torn from a larger sheet, in Vivi's handwriting: “11:35 — go”" },
  { code: "4-3", phase: 4, tag: "ANNOUNCE", title: "Opera binoculars", location: "Primary suite balcony — propped between the loveseat cushions.", content: "A pair of small black opera-style binoculars. Lens cap off, lens still warm. Found on the balcony loveseat — which has a direct sightline to the dock." },
  { code: "4-4", phase: 4, tag: "KEEP", title: "A sticky note", location: "Master bathroom of the primary suite — in the trash, under tissues.", content: "A balled-up sticky note, smoothed out, in Vivi's handwriting: “breathe. it's done.”" },
  { code: "4-5", phase: 4, tag: "KEEP", title: "The 11:35 bonfire photo", location: "Bottom floor — under the rim of the ping pong table, kitchen-side.", content: "EVIDENCE PHOTO, Saturday 11:35 PM. Six people around the bonfire: Hank, Catherine, Vivi, Beau, Eden, Bella. Vivi mid-gesture, telling a story. Note: Sebastian is not in this photograph." },
  // Phase 5
  { code: "5-1", phase: 5, tag: "ANNOUNCE", title: "Vivi's draft letter", location: "Vivi's overnight bag (retrieved in Phase 5 when Hank authorizes the search).", content: "A never-sent draft in Vivi's handwriting: “To whom I am angry with — Then I'll have to find another way. — V”" },
];
